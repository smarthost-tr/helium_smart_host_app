export default {
  ...
  account_setup: {
    ...
    welcome: {
      ...
      subtitle:
        'Smart Host, Helium currently supports hotspot onboarding, location assertion, and device transfers.\n\n<b>You must also have the official Helium App installed in order to continue.</b>',
      title: 'Welcome\nto Smart Host',
    },
    linkAccount: {
  ...
  hotspot_setup: {
    ...
    pair: {
      ...
      alert_no_permissions: {
        body:
          'The Smart Host Hotspot needs permission to use Bluetooth. You can enable Bluetooth permission in Settings.',
  ...
  hotspots: {
    ...
    empty: {
      ...
      title: 'Smart Host Hotspot Setup',
    },
  },
  learn: {
    next: 'Next',
  ...
  permissions: {
    location: {
      message:
        'The Smart Host Hotspot App needs access to your location for Bluetooth discovery and to enable location assertion. This information will never be sold or shared.',
